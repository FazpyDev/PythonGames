...
def score_display(game_state):
	...
	if game_state == 'game_over':
		...
		screen.blit(score_surface,score_rect)
		credit_surface = game_font.render('FLAPPYBIRD' ,True,(255,255,255))
		credit_rect = score_surface.get_rect(center = (265,100))
...
pygame.display.set_caption("FlappyBird BY FAZPYDEV")
...
death_sound = pygame.mixer.Sound('Assets/sfx_die.wav')
